...
class PersonalityController extends Controller
{
    ...
    /**
     * Rename a category (updates all personalities with that type)
     */
    public function updateCategory(Request $request)
    {
        try {
            ...
            Personality::where('personality_type', $validated['old_type'])
                ->update(['personality_type' => $validated['new_type']]);
    ...
    /**
     * Delete a category (deletes all personalities with that type)
     */
    public function deleteCategory(Request $request)
    {
        try {
            ...
            Personality::where('personality_type', $validated['type'])->delete();

            return response()->json([
                'success' => true,
                'message' => 'Category and its personalities deleted successfully'
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
